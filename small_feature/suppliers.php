...
<body>
        ...
        <section class="body-main">
            <form action="suppliers_process.php" method="POST">
                <div class="inputs">
                    ...
                    <label>
                        name
                        <input type="text" name="name" class="supplier_data" required onchange="changeID()">
                    </label>
                    <label>
                        phone
    ...
    <script>
        ...
        var changeID = () => {
            var id = document.querySelectorAll(".supplier_data");
            id[0].value = "-1";
        }
        ...
        function getSupplier(id) {
            ...
            xhttp.open("GET", "../buying/data/supplier.php?q=" + id, true);
            xhttp.send();
        }
    </script>
</body>
